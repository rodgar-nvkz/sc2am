...
2. Out of the range of sight: > 12. Attack command will do nothing.

This gives ability to split the task into:
1. Learn to kite if nearby
2. Learn to chase if far away
3. Combine to solve the full task
