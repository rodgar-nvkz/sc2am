...
Usage:
    python -m smarte.train.ppo_torchrl train --steps 100000 --num-envs 8
    python -m smarte.train.ppo_torchrl train --steps 100000 --num-envs 8 --compile --cudagraphs
    python -m smarte.train.ppo_torchrl eval --games 10
    python -m smarte.train.ppo_torchrl train --steps 100000 --resume artifacts/models/marine_torchrl_ppo_xxx.pt
"""
...
from smarte.envs.trl_v0 import NUM_ACTIONS, OBS_SIZE, SC2TRLEnv
