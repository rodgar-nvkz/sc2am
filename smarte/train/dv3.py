...
Usage:
    python -m smarte.train.dv3 train --num-envs 2 --steps 100000
    python -m smarte.train.dv3 train --model-size S --training-ratio 512
    python -m smarte.train.dv3 eval --checkpoint <path> --games 10
"""
...
def train(
    ...
    if best_result.checkpoint:
        ...
        print(f"  python -m smarte.train.dv3 eval --checkpoint {best_result.checkpoint.path}")
...
def eval(
    ...
    if checkpoint_path is None:
        ...
        if not checkpoint_dirs:
            print("No checkpoints found. Train a model first with: python -m smarte.train.dv3 train")
            return
