...
Run with: python -m smarte.smarte_v1.test_env [test_number|a]
Examples:
    python -m smarte.smarte_v1.test_env 1    # Run movement test
    python -m smarte.smarte_v1.test_env a    # Run all tests
    python -m smarte.smarte_v1.test_env      # Interactive mode
"""
