...
Usage:
    python -m scam.train.ppo_v2 train --steps 100000 --num-envs 10
    python -m scam.train.ppo_v2 eval --games 10
    python -m scam.train.ppo_v2 demo
"""
...
from scam.envs.gym_v2 import SC2GymEnv
...
def eval(
    ...
    if model_path is None:
        try:
            ...
            print(
                "No trained model found. Train one first with: python -m scam.train.ppo_v2 train"
            )
            return
